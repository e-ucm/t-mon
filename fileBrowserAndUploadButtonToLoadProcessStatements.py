...
def load_players_info_from_file(file, players_info, out, err):
...
def load_players_info_from_content(filecontent, filename, players_info, out, err):
    content_type, content_string = filecontent.split(',')
    decoded = base64.b64decode(content_string)
    progress = Progress(0)
    load_from_string(decoded.decode('utf-8'), progress, out, err, players_info, timeformats)